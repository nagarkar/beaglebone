...
#define DEFAULT_SAMPLE_FREQ	930.0f		// sample frequency in Hz
#define DEFAULT_BETA		0.1f		// 2 * proportional gain

//---------------------------------------------------------------------------------------------------
// Variable definitions

volatile float beta = DEFAULT_BETA;
volatile float sampleFreq = DEFAULT_SAMPLE_FREQ;
